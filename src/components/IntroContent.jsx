  ...
  return (
    <>
      <div className='bg-gray-200 p-4 flex'>
        ...
        <div className='flex justify-center items-center w-3/4 h-1/2'>
            <img src={frontPagePoster} alt="Poster Image 1" className='w-100 h-100 rounded-lg p-5 m-5'/>
        </div>
      </div>
      
      <div className='bg-black p-4 flex text-white'>
        <div className='flex justify-center items-center w-3/4 h-1/2'>
            <img src={ronaldoImage} alt="Poster Image 2" className='w-100 h-110 rounded-lg p-5 m-5'/>
        </div>
        <div className='flex flex-col justify-center'>
